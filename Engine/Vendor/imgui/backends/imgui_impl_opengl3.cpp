...
//  shader_ptr_ program bound" if it was the case prior to running the rendering function. (#6267, #6220, #6224)
//  2023-03-15: OpenGL: Fixed GL loader crash when GL_VERSION returns NULL. (#6154, #4445, #3530)
//  2023-03-06: OpenGL: Fixed restoration of a potentially deleted OpenGL program, by calling glIsProgram(). (#6220,
//  #6224) 2022-11-09: OpenGL: Reverted use of glBufferSubData(), too many corruptions issues + old issues seemingly
//  can't be reproed with Intel drivers nowadays (revert 2021-12-15 and 2022-05-23 changes). 2022-10-11: Using 'nullptr'
//  instead of 'NULL' as per our switch to C++11. 2022-09-27: OpenGL: Added ability to '#define
//  IMGUI_IMPL_OPENGL_DEBUG'. 2022-05-23: OpenGL: Reworking 2021-12-15 "Using buffer orphaning" so it only happens on
//  Intel GPU, seems to cause problems otherwise. (#4468, #4825, #4832, #5127). 2022-05-13: OpenGL: Fixed state
//  corruption on OpenGL ES 2.0 due to not preserving GL_ELEMENT_ARRAY_BUFFER_BINDING and vertex attribute states.
//  2021-12-15: OpenGL: Using buffer orphaning + glBufferSubData(), seems to fix leaks with multi-viewports with some
//  Intel HD drivers. 2021-08-23: OpenGL: Fixed ES 3.0 shader_ptr_ ("#version 300 es") use normal precision floats to
//  avoid wobbly rendering at HD resolutions. 2021-08-19: OpenGL: Embed and use our own minimal GL loader
...
//  2021-06-21: OpenGL: Destroy individual vertex/fragment shader_ptr_ objects right after they are linked into the main
//  shader_ptr_. 2021-05-24: OpenGL: Access GL_CLIP_ORIGIN when "GL_ARB_clip_control" extension is detected, inside of
//  just OpenGL 4.5 version. 2021-05-19: OpenGL: Replaced direct access to ImDrawCmd::TextureId with a call to
...
//  call it yourself. 2018-01-07: OpenGL: Changed GLSL shader_ptr_ version from 330 to 150. 2017-09-01: OpenGL: Save and
