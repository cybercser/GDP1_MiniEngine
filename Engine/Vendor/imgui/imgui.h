...
IMGUI_API ImVec2 GetWindowPos();   // get current window position in screen space (note: it is unlikely you need to use
                                   // this. Consider using current layout pos instead, GetScreenCursorPos())
IMGUI_API ImVec2 GetWindowSize();  // get current window size (note: it is unlikely you need to use this. Consider using
                                   // GetScreenCursorPos() and e.g. GetContentRegionAvail() instead)
...
//  B) render a complex 3D scene_ptr_ inside a UI element without an intermediate texture/render target, etc.
...
// for imgui contents (e.g. changing shader_ptr_/blending settings before an Image call).
